...
(function() {
    ...
    function createExportPanel() {
        ...
        panel.innerHTML = `
            <div style="background: #10a37f; color: white; padding: 10px 12px; font-weight: bold;">
                Message Exporter
            </div>
            <div style="display: flex; flex-direction: column; padding: 8px;">
                <button id="select-all-btn" class="exporter-btn">Select All</button>
                <button id="deselect-btn" class="exporter-btn">Deselect All</button>
                <button id="copy-btn" class="exporter-btn">Copy Selected</button>
                <div style="height: 1px; background: #e5e5e5; margin: 8px 0;"></div>
                <button id="save-md-btn" class="exporter-btn">Save as Markdown</button>
                <button id="save-txt-btn" class="exporter-btn">Save as Text</button>
                <button id="save-html-btn" class="exporter-btn">Save as HTML</button>
            </div>
        ...
        // Initialize message selection system
        initializeMessageSelection();
